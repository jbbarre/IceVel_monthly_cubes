! FILE: cube2vel_feather_sp_f2py.F90
SUBROUTINE cube2vel_feather_sp1(vx0,vy0,errx0,erry0,weightx0,weighty0, & ! input
    ...
    !f2py intent(hide),depend(c_refimg) :: nx=shape(vx0,0), ny=shape(vx0,1), nz=shape(vx0,2)
