...
int cube2vel_feather_sp(int argc, void *argv[])

{
    extern void cube2vel_feather_sp1_(); /* Declare The Fortran Routine */
    ...
    cube2vel_feather_sp1_(vx,vy,nx,ny,nz,errx,erry,weightx,weighty, \
